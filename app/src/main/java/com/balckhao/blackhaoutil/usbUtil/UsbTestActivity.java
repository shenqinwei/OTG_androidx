...
public class UsbTestActivity extends AppCompatActivity implements USBBroadCastReceiver.UsbListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        localBackspaceIv=  findViewById(R.id.local_backspace_iv);
        localFileLv=  findViewById(R.id.local_file_lv);
        usbBackspaceIv=  findViewById(R.id.usb_backspace_iv);
        usbFileLv=  findViewById(R.id.usb_file_lv);
